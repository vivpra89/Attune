...
export const Audio = ({
  ...
  const { selectedSttProvider, hostedApiEnabled, selectedAudioDevices } =
    useApp();
  ...
  return (
    <Popover open={micOpen} onOpenChange={setMicOpen}>
      <PopoverTrigger asChild>
        {(hostedApiEnabled || speechProviderStatus) && enableVAD ? (
          <AutoSpeechVAD
      ...
      <PopoverContent
        ...
        side="bottom"
        className={`w-80 p-3 ${
          hostedApiEnabled || speechProviderStatus ? "hidden" : ""
        }`}
        sideOffset={8}
      >
